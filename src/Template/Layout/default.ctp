...
//$this->append('css', $this->Html->css(['flatui/flat-ui.min']));

$this->append('css', $html5Shim);
$this->append('css', $this->Html->css('vote.css'));
...
//$this->prepend('script', $this->Html->script(['jquery/jquery', 'bootstrap/bootstrap', 'flatui/flat-ui.min']));
